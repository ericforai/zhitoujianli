...
import { analyzeResumeAndJD, parseResumeFile, type ResumeData, type GreetingSettings, type AnalysisResult } from '../services/aiService';
                    ...
                    {[
                      ...
                      <label key={option.value} className="flex items-center">
                        <input
                          ...
                          onChange={(e) => setGreetingSettings({
                            ...greetingSettings,
