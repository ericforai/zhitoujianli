        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            ...
            <div className="p-6">
              ...
              <a href="http://localhost:4321/blog/resume-optimization-tips/" className="text-indigo-600 hover:text-indigo-800 font-medium">
                阅读更多 →
              </a>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            ...
            <div className="p-6">
              ...
              <a href="http://localhost:4321/blog/interview-preparation-guide/" className="text-indigo-600 hover:text-indigo-800 font-medium">
                阅读更多 →
              </a>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden">
            ...
            <div className="p-6">
              ...
              <a href="http://localhost:4321/blog/zhitoujianli-introduction/" className="text-indigo-600 hover:text-indigo-800 font-medium">
                阅读更多 →
              </a>
            </div>
          </div>
