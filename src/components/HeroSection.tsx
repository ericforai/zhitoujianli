          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            用AI帮你更快拿到心仪Offer
                 ...
                 <div className="flex flex-col sm:flex-row gap-4 justify-center">
                   ...
                   <a href="http://localhost:8080" target="_blank" rel="noopener noreferrer" className="bg-gray-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:opacity-90 transition-all duration-300 transform hover:scale-105 shadow-lg text-center">
                     后台管理
                   </a>
