      ...
      <div className="flex items-start">
        ...
        <div className="ml-4 flex-1">
          ...
          <p className="mt-2 text-sm text-gray-600">
            您当前使用的是{userPlan?.planName}，
            {featureName}需要升级到
            {recommendedPlan && getPlanName(recommendedPlan)}
            {recommendedPlan && getPlanPrice(recommendedPlan) && `（${getPlanPrice(recommendedPlan)}/月）`}
            才能使用。
          </p>
          ...
          {recommendedPlan && (
            <div className="mt-4 space-y-2">
              <p className="text-sm font-medium text-gray-900">升级后您将获得：</p>
