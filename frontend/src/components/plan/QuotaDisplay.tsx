    ...
    <div className={`bg-white rounded-lg shadow ${className}`}>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              ...
              {userPlan.planType === 'PROFESSIONAL' && `¥${userPlan.monthlyPrice}/月`}
            </p>
          </div>
      ...
      <div className="p-6 space-y-6">
        {mainQuotas.map((quota) => {
          ...
          const actualUsed = quota.key === 'daily_job_application' && overrideDailyDeliveryCount !== undefined
            ? overrideDailyDeliveryCount
            : quotaInfo.used;
          const actualRemaining = quotaInfo.unlimited ? 999 : quotaInfo.limit - actualUsed;
          const actualPercentage = quotaInfo.unlimited ? 0 : (actualUsed / quotaInfo.limit) * 100;
