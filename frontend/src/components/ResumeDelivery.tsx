                    ...
                    <div className='space-y-3'>
                      <button
                        onClick={() => {
                          ...
                          if (token) {
                            window.open(
                              `http://115.190.182.95:8080/token?token=${encodeURIComponent(token)}`,
                              '_blank'
                            );
                          } else {
                      ...
                      <button
                        onClick={() => {
                          ...
                          if (token) {
                            window.open(
                              `http://115.190.182.95:8080/token?token=${encodeURIComponent(token)}#resume-manager`,
                              '_blank'
                            );
                          } else {
                            window.open(
                              'http://115.190.182.95:8080/resume-manager',
                              '_blank'
                            );
                          }
                        }}
                      ...
                      <button
                        onClick={() =>
                          window.open(
                            'http://115.190.182.95:8080?start=true',
                            '_blank'
                          )
                        }
              ...
              <div className='space-y-6'>
                ...
                <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-6'>
                  ...
                  <div className='space-y-2 text-yellow-700 text-sm'>
                    ...
                    <p>
                      <strong>第三步：</strong>
                      点击&quot;开始自动投递&quot;启动AI自动投递流程
                    </p>
                    <p>
                      <strong>第四步：</strong>在后台管理页面监控投递进度和结果
                    </p>
                  </div>
                </div>
              </div>
