...
const LocalAgentGuidePage: React.FC = () => {
  ...
  const faqs = [
    ...
    {
      q: 'Token过期了怎么办？',
      a: 'Token默认约30天有效（以配置页展示为准）。过期后在「配置管理」→「本地投递」重新生成Token，并用页面给出的「serverUrl」与 Token 一起启动 Agent（二者须来自同一次生成）。',
    },
    {
      q: '投递时遇到验证码怎么办？',
    ...
    <div className='min-h-screen bg-gray-50'>
      <SEOHead
        ...
        breadcrumbs={[
          ...
          {
            name: '本地Agent指南',
            url: 'https://zhitoujianli.com/guide/local-agent',
          },
        ]}
      />
      <Navigation />
            ...
            <div className='flex items-start gap-4'>
              ...
              <div>
                ...
                <p className='text-amber-800'>
                  本地Agent是一种<strong>全新的投递方式</strong>
                  ，与之前的服务器投递完全不同。
              ...
              <table className='w-full border-collapse'>
                <thead>
                  <tr className='bg-gray-100'>
                    ...
                    <th className='border border-gray-200 px-4 py-3 text-left font-semibold text-gray-500'>
                      旧方式（服务器投递）
                    </th>
                    <th className='border border-gray-200 px-4 py-3 text-left font-semibold text-green-600'>
                      新方式（本地Agent）
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td className='border border-gray-200 px-4 py-3 text-green-600'>
                      您的电脑
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td className='border border-gray-200 px-4 py-3 text-amber-600'>
                      是（投递时需要）
                    </td>
                  </tr>
                  <tr className='bg-gray-50'>
                ...
                <div className='bg-white rounded-lg shadow-sm p-8'>
                  ...
                  <div className='grid md:grid-cols-2 gap-6'>
                    ...
                    <div>
                      ...
                      <ul className='space-y-2 text-gray-700'>
                        <li className='flex items-center gap-2'>
                          <span className='text-green-500'>✓</span> Windows
                          10/11 或 macOS 10.15+ 或 Linux
                        </li>
                        <li className='flex items-center gap-2'>
                          <span className='text-green-500'>✓</span> Python 3.8
                          或更高版本
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className='space-y-6'>
                    ...
                    <div className='border-l-4 border-blue-500 pl-6'>
                      ...
                      <ol className='list-decimal list-inside text-gray-700 space-y-1 ml-4'>
                        <li>
                          直接解压下载的 `local-agent.zip` 并双击启动器即可
                        </li>
                        <li>
                          启动器会在首次运行时提示你输入智投简历账号与密码（默认走邮箱/密码登录）
                        </li>
                        <li>
                          如果你不想输入账号密码，也可以在「配置管理」→「本地投递」里生成
                          Token 作为高级用法（可选）
                        </li>
                      </ol>
                      <div className='mt-3'>
                    ...
                    <div className='border-l-4 border-green-500 pl-6'>
                      ...
                      <p className='text-gray-700 mb-4'>
                        解压后直接运行启动器。首次会自动创建虚拟环境并安装依赖，后续基本双击即可。
                      </p>
                      ...
                      <div className='bg-green-50 border-2 border-green-300 rounded-lg p-4 mb-4'>
                        ...
                        <pre className='bg-gray-900 text-green-400 p-3 rounded-lg text-sm overflow-x-auto'>{`双击运行：start.command`}</pre>
                        <p className='text-green-700 text-sm mt-2'>
                          首次会自动安装依赖；若系统阻止双击，可在终端执行：
                      ...
                      <div className='bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4'>
                        ...
                        <pre className='bg-gray-900 text-green-400 p-3 rounded-lg text-sm overflow-x-auto'>{`双击运行：start.bat`}</pre>
                      ...
                      <div className='bg-amber-50 border border-amber-200 p-4 rounded-lg mb-4'>
                        ...
                        <ul className='space-y-2 text-amber-800 text-sm'>
                          <li>
                            启动器会创建本地虚拟环境并安装依赖（可能需要几分钟，取决于网络）
                          </li>
                          <li>随后会自动打开/准备浏览器以开始连接并投递</li>
                          <li>
                            如果失败：请优先查看解压目录下的
                            <code className='bg-amber-100 px-1 rounded ml-1'>
                              boss_agent.log
              ...
              <div className='space-y-8'>
                  ...
                  <div className='space-y-6'>
                    <div className='bg-green-50 border-2 border-green-300 rounded-lg p-4'>
                      ...
                      <p className='text-green-800 text-sm mb-3'>
                        解压后双击启动器即可（Mac/Linux: start.command，Windows:
                        start.bat）。
                      </p>
                      <pre className='bg-gray-900 text-green-400 p-3 rounded-lg text-sm overflow-x-auto'>{`高级命令行：python3 start_one_click.py --headless`}</pre>
                    </div>
                    <div className='bg-gray-50 border border-gray-200 rounded-lg p-4'>
                      ...
                      <p className='text-gray-600 text-sm mb-3'>
                        如需后台运行（不显示浏览器窗口），添加 --headless 参数：
                      </p>
                      <pre className='bg-gray-900 text-green-400 p-3 rounded-lg text-sm overflow-x-auto'>
                        {`python3 boss_local_agent.py --token YOUR_TOKEN --server "YOUR_SERVER_URL" --headless`}
                      </pre>
                    </div>
                  </div>
                </div>
                    ...
                    <table className='w-full border-collapse'>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className='border border-gray-200 px-4 py-3'>
                            WebSocket 地址，须与 Token
                            同属一台后端；配置页「生成 Token」接口会返回
                            serverUrl
                          </td>
                          <td className='border border-gray-200 px-4 py-3 text-gray-500 text-sm'>
                            生产示例
                            wss://www.zhitoujianli.com/ws/local-agent；本地示例
                            ws://localhost:8080/ws/local-agent
                          </td>
                        </tr>
                        <tr className='bg-gray-50'>
                          <td className='border border-gray-200 px-4 py-3 font-mono text-sm'>
                ...
                <div className='bg-white rounded-lg shadow-sm p-8'>
                  ...
                  <div className='mt-6 bg-amber-50 p-4 rounded-lg'>
                    <p className='text-amber-800'>
                      <strong>建议：</strong>
                      首次使用必须用有头模式完成Boss直聘登录，之后可以切换到无头模式长期运行。
                    </p>
                  </div>
                </div>
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-gray-600'>
                          在终端运行启动命令，等待显示&ldquo;认证成功&rdquo;
                        </p>
                      </div>
                    </div>
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-gray-600'>
                          在「配置管理」→「本地投递」查看Agent状态为&ldquo;在线&rdquo;
                        </p>
                      </div>
                    </div>
                    <div className='flex items-start gap-4'>
                      ...
                      <div>
                        ...
                        <p className='text-gray-600'>
                          在Dashboard点击&ldquo;开始投递&rdquo;，任务会自动发送到您的Agent执行
                        </p>
                      </div>
                    </div>
                    <div className='flex items-start gap-4'>
