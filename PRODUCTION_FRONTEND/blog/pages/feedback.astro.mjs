...
其他联系方式
</h2> <div class="grid md:grid-cols-3 gap-6"> <a href="mailto:zhitoujianli@qq.com" class="block p-6 bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow"> ${renderComponent($$result2, "Icon", $$Icon, { "name": "tabler:mail", "class": "w-8 h-8 text-primary mx-auto mb-3" })} <h3 class="font-semibold mb-2">邮件反馈</h3> <p class="text-sm text-muted dark:text-slate-400">zhitoujianli@qq.com</p> </a> <a href="/contact" class="block p-6 bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow"> ${renderComponent($$result2, "Icon", $$Icon, { "name": "tabler:headphones", "class": "w-8 h-8 text-primary mx-auto mb-3" })} <h3 class="font-semibold mb-2">在线客服</h3> <p class="text-sm text-muted dark:text-slate-400">工作日9:00-18:00</p> </a> <a href="/faq" class="block p-6 bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow"> ${renderComponent($$result2, "Icon", $$Icon, { "name": "tabler:help", "class": "w-8 h-8 text-primary mx-auto mb-3" })} <h3 class="font-semibold mb-2">常见问题</h3> <p class="text-sm text-muted dark:text-slate-400">查看FAQ快速解答</p> </a> </div> </div> </section> ` })}`;
