...
const $$AboutNew = createComponent(($$result, $$props, $$slots) => {
  const metadata = {
    title: "\u5173\u4E8E\u6211\u4EEC - \u667A\u6295\u7B80\u5386",
...
凭借先进的大语言模型技术和深度学习算法，我们已经帮助数万名求职者提升了求职成功率，
            ...
            让每个人都能找到心仪的工作。
</p> </div> </div> </div> <!-- 使命愿景 --> <div id="mission-vision" class="mb-16 scroll-mt-20"> <h2 class="text-3xl font-bold font-heading mb-8 text-center"> ${renderComponent($$result2, "Icon", $$Icon, { "name": "tabler:target", "class": "w-8 h-8 inline-block mr-3 text-primary" })}
使命愿景
...
}, "/root/zhitoujianli/blog/zhitoujianli-blog/src/pages/about-new.astro", void 0);

const $$file = "/root/zhitoujianli/blog/zhitoujianli-blog/src/pages/about-new.astro";
const $$url = "/about-new/";
