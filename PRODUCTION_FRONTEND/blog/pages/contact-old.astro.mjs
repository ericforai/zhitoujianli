import { c as createComponent, f as createAstro, m as maybeRenderHead, b as addAttribute, a as renderTemplate, r as renderComponent } from '../chunks/astro/server_BMxpr7GR.mjs';
import 'kleur/colors';
import { a as $$Button, $ as $$PageLayout } from '../chunks/PageLayout_CYieUw40.mjs';
import { $ as $$HeroText } from '../chunks/HeroText_BZ7zPPN3.mjs';
...
}, "/root/zhitoujianli/blog/zhitoujianli-blog/src/components/ui/Form.astro", void 0);
...
}, "/root/zhitoujianli/blog/zhitoujianli-blog/src/components/widgets/Contact.astro", void 0);

const $$ContactOld = createComponent(($$result, $$props, $$slots) => {
  const metadata = {
    title: "Contact"
  };
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "HeroText", $$HeroText, { "tagline": "Contact", "title": "Let's Connect!" })} ${renderComponent($$result2, "ContactUs", $$Contact, { "id": "form", "title": "Drop us a message today!", "subtitle": "For quicker answers, explore our FAQs section. You may find the solution you're looking  for right there! If not, our support team is delighted to help you.", "inputs": [
    {
      type: "text",
      name: "name",
      label: "Name"
...
}, "/root/zhitoujianli/blog/zhitoujianli-blog/src/pages/contact-old.astro", void 0);

const $$file = "/root/zhitoujianli/blog/zhitoujianli-blog/src/pages/contact-old.astro";
const $$url = "/contact-old/";
