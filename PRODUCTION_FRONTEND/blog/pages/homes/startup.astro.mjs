import { c as createComponent, f as createAstro, r as renderComponent, a as renderTemplate, m as maybeRenderHead, u as unescapeHTML, e as renderScript, b as addAttribute, F as Fragment, s as spreadAttributes, g as renderSlot } from '../../chunks/astro/server_BMxpr7GR.mjs';
import 'kleur/colors';
import { $ as $$PageLayout } from '../../chunks/PageLayout_CYieUw40.mjs';
import { $ as $$Hero } from '../../chunks/Hero_C-ynFJ5O.mjs';
import { $ as $$CallToAction } from '../../chunks/CallToAction_DR3nJ6Q_.mjs';
import { $ as $$Features2 } from '../../chunks/Features2_BCcocTQK.mjs';
import { $ as $$Features } from '../../chunks/Features_C2h73s6r.mjs';
import { $ as $$Stats } from '../../chunks/Stats_CzFWr7fR.mjs';
import { $ as $$Features3 } from '../../chunks/Features3_t0lwttXc.mjs';
import { $ as $$FAQs } from '../../chunks/FAQs_Drz6dbb_.mjs';
import { a as $$Icon, c as createSvgComponent } from '../../chunks/Layout_ClwenmRe.mjs';
import { $ as $$Image } from '../../chunks/Image_Du4bkZ4U.mjs';
import { $ as $$Headline } from '../../chunks/Headline_BLeHX4ag.mjs';
...
}, "/root/zhitoujianli/blog/zhitoujianli-blog/src/components/widgets/Brands.astro", void 0);
...
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-twitter/Tweet.astro", void 0);
...
const $$LinkPreview = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ], "class:list")} data-astro-cid-yr6irx5u><div class="link-preview__content" data-astro-cid-yr6irx5u><header data-astro-cid-yr6irx5u><a class="link-preview__title"${addAttribute(id, "href")} data-astro-cid-yr6irx5u>${meta.title}</a>${" "}${domain && renderTemplate`<small class="link-preview__domain" data-astro-cid-yr6irx5u>${domain}</small>`}</header><small class="link-preview__description" data-astro-cid-yr6irx5u>${meta.description}</small></div>${hideMedia ? null : meta.video && meta.videoType ? renderTemplate`<video controls preload="metadata" width="1200" height="630" data-astro-cid-yr6irx5u><source${addAttribute(meta.video, "src")}${addAttribute(meta.videoType, "type")} data-astro-cid-yr6irx5u></video>` : meta.image ? renderTemplate`<img${addAttribute(meta.image, "src")}${addAttribute(meta.imageAlt || "", "alt")} width="1200" height="630" data-astro-cid-yr6irx5u>` : null}</article>` : renderTemplate`<div class="link-preview link-preview--no-metadata" data-astro-cid-yr6irx5u><a${addAttribute(id, "href")} data-astro-cid-yr6irx5u>${id}</a></div>`}`;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-link-preview/LinkPreview.astro", void 0);
...
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-baseline-status/BaselineIcon.astro", void 0);
...
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-baseline-status/BrowserIcon.astro", void 0);
...
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-baseline-status/SupportIcon.astro", void 0);
...
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-baseline-status/BrowserSupport.astro", void 0);
...
const $$BaselineStatus = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`baseline-status baseline-status--${baseline}`, "class")} data-astro-cid-2kfks7yi> <template shadowrootmode="open" data-astro-cid-2kfks7yi> <div part="root" data-astro-cid-2kfks7yi> <p part="feature-name" data-astro-cid-2kfks7yi>${feature.name}</p> <details part="details" data-astro-cid-2kfks7yi> <summary part="summary" data-astro-cid-2kfks7yi> ${renderComponent($$result, "BaselineIcon", $$BaselineIcon, { "support": baseline, "data-astro-cid-2kfks7yi": true })} <div part="summary-content" data-astro-cid-2kfks7yi> <div part="summary-label" data-astro-cid-2kfks7yi> ${!(baseline === "limited" || baseline === "no_data") && renderTemplate`<strong data-astro-cid-2kfks7yi>Baseline</strong>`} ${title} ${year} ${baseline === "newly" && renderTemplate`<span part="badge" data-astro-cid-2kfks7yi>newly available</span>`} </div> <div part="browsers" data-astro-cid-2kfks7yi> ${renderComponent($$result, "BrowserSupport", $$BrowserSupport, { "browser": "chrome", "feature": feature, "data-astro-cid-2kfks7yi": true })} ${renderComponent($$result, "BrowserSupport", $$BrowserSupport, { "browser": "edge", "feature": feature, "data-astro-cid-2kfks7yi": true })} ${renderComponent($$result, "BrowserSupport", $$BrowserSupport, { "browser": "firefox", "feature": feature, "data-astro-cid-2kfks7yi": true })} ${renderComponent($$result, "BrowserSupport", $$BrowserSupport, { "browser": "safari", "feature": feature, "data-astro-cid-2kfks7yi": true })} </div> </div> <style>
						[part='caret'] svg {
					...
					</style> <span part="caret" aria-hidden="true" data-astro-cid-2kfks7yi> <svg width="11" height="7" fill="currentColor" data-astro-cid-2kfks7yi> <path d="M5.5 6.45.25 1.2l.94-.94L5.5 4.6 9.8.3l.95.94L5.5 6.45Z" data-astro-cid-2kfks7yi></path> </svg> </span> </summary> <p part="description" data-astro-cid-2kfks7yi>${unescapeHTML(description)}</p> ${baseline !== "no_data" && renderTemplate`<p part="link-container" data-astro-cid-2kfks7yi> <a${addAttribute(`https://webstatus.dev/features/${feature.feature_id}`, "href")} target="_top" part="link" data-astro-cid-2kfks7yi>${`${feature.name} on Web Platform Status`}</a> </p>`} </details> </div> </template> </div> `;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-baseline-status/BaselineStatus.astro", void 0);
...
const $$External = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(uri, "href")} target="_blank" rel="noopener noreferrer nofollow" class="external-link" data-astro-cid-4tcbb4hq> ${!compact && thumb && renderTemplate`<img${addAttribute(thumb, "src")}${addAttribute(title, "alt")} class="thumbnail" data-astro-cid-4tcbb4hq>`} <div class="content" data-astro-cid-4tcbb4hq> <p class="domain" data-astro-cid-4tcbb4hq>${domain}</p> ${!compact && renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-4tcbb4hq": true }, { "default": ($$result2) => renderTemplate` <p class="title" data-astro-cid-4tcbb4hq>${title}</p> <p class="description" data-astro-cid-4tcbb4hq>${description}</p> ` })}`} </div> </a> `;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/external.astro", void 0);
...
const $$ImageGrid = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="image-grid-container" data-astro-cid-joljqxmh> <div${addAttribute(["image-grid", `image-grid--${images.length}`], "class:list")} data-astro-cid-joljqxmh> ${images.map((image) => renderTemplate`<div class="image-grid-item" data-astro-cid-joljqxmh> <img${addAttribute(image.thumb, "src")}${addAttribute(image.alt || "", "alt")} loading="lazy" decoding="async" data-astro-cid-joljqxmh> </div>`)} </div> </div> `;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/image-grid.astro", void 0);
...
const $$MediaContainer = createComponent(($$result, $$props, $$slots) => {
  ...
  }, "style")}${spreadAttributes(onClick ? { onClick } : {})} data-astro-cid-fcmsix77> ${renderSlot($$result, $$slots["default"])} </div> `;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/media-container.astro", void 0);
...
const $$VideoThumbnail = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MediaContainer", $$MediaContainer, { "aspectRatio": aspectRatio, "data-astro-cid-l5jfivfb": true }, { "default": ($$result2) => renderTemplate`${thumbnail && renderTemplate`${maybeRenderHead()}<img${addAttribute(thumbnail, "src")} class="thumbnail" alt="Video thumbnail" data-astro-cid-l5jfivfb>`}<div class="play-button" data-astro-cid-l5jfivfb> <img src="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20fill='none'%20viewBox='0%200%2024%2024'%3e%3cpath%20fill='%23fff'%20d='M9.576%202.534C7.578%201.299%205%202.737%205%205.086v13.828c0%202.35%202.578%203.787%204.576%202.552l11.194-6.914c1.899-1.172%201.899-3.932%200-5.104L9.576%202.534Z'/%3e%3c/svg%3e" class="play-icon" alt="Play button" data-astro-cid-l5jfivfb> </div> ` })} `;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/video-thumbnail.astro", void 0);
...
const $$Avatar = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${link ? renderTemplate`${maybeRenderHead()}<a${addAttribute(["avatar", size], "class:list")}${addAttribute(`https://bsky.app/profile/${user?.handle}`, "href")} target="_blank" rel="noopener noreferrer nofollow" data-astro-cid-wzfmbpku>${src && renderTemplate`<img${addAttribute(src, "src")}${addAttribute(user.displayName ?? user.handle, "alt")} data-astro-cid-wzfmbpku>`}</a>` : renderTemplate`<div${addAttribute(["avatar", size], "class:list")} data-astro-cid-wzfmbpku>${src && renderTemplate`<img${addAttribute(src, "src")}${addAttribute(user.displayName ?? user.handle, "alt")} data-astro-cid-wzfmbpku>`}</div>`}`;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/avatar.astro", void 0);
...
const $$QuoteEmbed = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${AppBskyEmbedRecord.isViewRecord(embed.record) && AppBskyFeedPost.isRecord(embed.record.value) ? renderTemplate`${maybeRenderHead()}<div class="post-container" data-astro-cid-vxzx5jbq><a${addAttribute(atUriToPostUri(embed.record.uri), "href")} class="post-link" data-astro-cid-vxzx5jbq><div class="user-info" data-astro-cid-vxzx5jbq>${renderComponent($$result, "Avatar", $$Avatar, { "user": embed.record.author, "size": "small", "data-astro-cid-vxzx5jbq": true })}<p class="user-text" data-astro-cid-vxzx5jbq><span class="name" data-astro-cid-vxzx5jbq>${embed.record.author.displayName}</span><span class="handle" data-astro-cid-vxzx5jbq>@${embed.record.author.handle}</span></p></div></a><a${addAttribute(atUriToPostUri(embed.record.uri), "href")} class="post-link" data-astro-cid-vxzx5jbq><p class="content" data-astro-cid-vxzx5jbq>${embed.record.value.text}</p></a>${renderComponent($$result, "Embed", $$Embed, { "embed": viewRecordToEmbed(embed.record), "postUrl": atUriToPostUri(embed.record.uri), "compact": true, "data-astro-cid-vxzx5jbq": true })}</div>` : null}`;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/quote-embed.astro", void 0);
...
const $$Card = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")} target="_blank" rel="noopener noreferrer nofollow" class="card" data-astro-cid-lup7uuas> ${image && renderTemplate`<img class="cover-image"${addAttribute(image.src, "src")}${addAttribute(image.alt ?? "", "alt")} data-astro-cid-lup7uuas>`} <div class="content" data-astro-cid-lup7uuas> <div class="header" data-astro-cid-lup7uuas> ${renderComponent($$result, "Avatar", $$Avatar, { "user": avatarUser, "data-astro-cid-lup7uuas": true })} <div class="title-group" data-astro-cid-lup7uuas> <p class="title" data-astro-cid-lup7uuas>${title}</p> <p class="subtitle" data-astro-cid-lup7uuas>${subtitle}</p> </div> </div> ${description && renderTemplate`<p class="description" data-astro-cid-lup7uuas>${description}</p>`} </div> </a> `;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/card.astro", void 0);
...
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/starter-pack.astro", void 0);
...
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/list.astro", void 0);
...
const $$Embed = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${match(embed).when(AppBskyEmbedRecordWithMedia.isView, (embed2) => renderTemplate`${maybeRenderHead()}<div class="record-with-media" data-astro-cid-umdfym4a>${renderComponent($$result, "Astro.self", Astro2.self, { "embed": embed2.media, "postUrl": postUrl, "compact": compact, "data-astro-cid-umdfym4a": true })}${renderComponent($$result, "QuoteEmbed", $$QuoteEmbed, { "embed": embed2.record, "data-astro-cid-umdfym4a": true })}</div>`).when(AppBskyEmbedExternal.isView, (media) => renderTemplate`${renderComponent($$result, "External", $$External, { "embed": media, "compact": compact, "data-astro-cid-umdfym4a": true })}`).when(AppBskyEmbedImages.isView, (media) => renderTemplate`<a${addAttribute(postUrl, "href")} data-astro-cid-umdfym4a>${renderComponent($$result, "ImageGrid", $$ImageGrid, { "images": media.images, "data-astro-cid-umdfym4a": true })}</a>`).when(AppBskyEmbedVideo.isView, (media) => renderTemplate`<a${addAttribute(postUrl, "href")} data-astro-cid-umdfym4a>${renderComponent($$result, "VideoThumbnail", $$VideoThumbnail, { "thumbnail": media.thumbnail, "aspectRatio": media.aspectRatio, "data-astro-cid-umdfym4a": true })}</a>`).with(
    { record: P.when(AppBskyGraphDefs.isStarterPackViewBasic) },
    (media) => renderTemplate`${renderComponent($$result, "StarterPack", $$StarterPack, { "record": media.record, "data-astro-cid-umdfym4a": true })}`
  ).with({ record: P.when(AppBskyGraphDefs.isListView) }, (media) => renderTemplate`${renderComponent($$result, "List", $$List, { "record": media.record, "data-astro-cid-umdfym4a": true })}`).when(AppBskyEmbedRecord.isView, (media) => renderTemplate`${renderComponent($$result, "QuoteEmbed", $$QuoteEmbed, { "embed": media, "data-astro-cid-umdfym4a": true })}`).with(P.nullish, () => null).otherwise((media) => media?.$type)}`;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/embed.astro", void 0);
...
const $$Post = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="bluesky-post-container not-content" data-astro-cid-ykja6isf> <div class="post-content" data-astro-cid-ykja6isf> <div class="post-header" data-astro-cid-ykja6isf> ${renderComponent($$result, "Avatar", $$Avatar, { "user": author, "link": true, "data-astro-cid-ykja6isf": true })} <div class="user-info" data-astro-cid-ykja6isf> <a${addAttribute(authorUrl, "href")} class="display-name" data-astro-cid-ykja6isf>${author?.displayName}</a> <a${addAttribute(authorUrl, "href")} class="username" data-astro-cid-ykja6isf>@${author?.handle}</a> </div> <a${addAttribute(postUrl, "href")} class="logo-link" data-astro-cid-ykja6isf> <img src="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20fill='none'%20viewBox='0%200%20320%20286'%3e%3cpath%20fill='rgb(10,122,255)'%20d='M69.364%2019.146c36.687%2027.806%2076.147%2084.186%2090.636%20114.439%2014.489-30.253%2053.948-86.633%2090.636-114.439C277.107-.917%20320-16.44%20320%2032.957c0%209.865-5.603%2082.875-8.889%2094.729-11.423%2041.208-53.045%2051.719-90.071%2045.357%2064.719%2011.12%2081.182%2047.953%2045.627%2084.785-80%2082.874-106.667-44.333-106.667-44.333s-26.667%20127.207-106.667%2044.333c-35.555-36.832-19.092-73.665%2045.627-84.785-37.026%206.362-78.648-4.149-90.071-45.357C5.603%20115.832%200%2042.822%200%2032.957%200-16.44%2042.893-.917%2069.364%2019.147Z'/%3e%3c/svg%3e" class="bluesky-logo" alt="Bluesky" data-astro-cid-ykja6isf> </a> </div> <p class="post-text" data-astro-cid-ykja6isf>${unescapeHTML(body)}</p> ${embed && renderTemplate`${renderComponent($$result, "Embed", $$Embed, { "embed": embed, "postUrl": postUrl, "data-astro-cid-ykja6isf": true })}`} <a${addAttribute(postUrl, "href")} class="timestamp" data-astro-cid-ykja6isf> ${formatter.format(new Date(record.createdAt ?? ""))} </a> </div> </div> `;
}, "/root/zhitoujianli/node_modules/@astro-community/astro-embed-bluesky/src/post.astro", void 0);
...
}, "/root/zhitoujianli/blog/zhitoujianli-blog/src/pages/homes/startup.astro", void 0);

const $$file = "/root/zhitoujianli/blog/zhitoujianli-blog/src/pages/homes/startup.astro";
