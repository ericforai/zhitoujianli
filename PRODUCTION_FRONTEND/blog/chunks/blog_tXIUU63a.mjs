...
import { f as VALID_INPUT_FORMATS, h as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash, i as APP_BLOG, C as CATEGORY_BASE, T as TAG_BASE, B as BLOG_BASE } from './consts_DF0DE_Q3.mjs';
import { l as AstroError, z as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, B as renderUniqueStylesheet, C as renderScriptElement, D as createHeadAndContent, r as renderComponent } from './astro/server_BMxpr7GR.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Dmw_xKVF.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://blog.zhitoujianli.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BA_d6Pic.mjs').then(n => n._);
