...
export const autoDeliveryService = {
  ...
  > => {
    const response = await apiClient.post('/delivery/start');
    return response.data;
  },
  ...
  > => {
    const response = await apiClient.post('/delivery/stop');
    return response.data;
  },
  ...
  > => {
    const response = await apiClient.get('/delivery/status');
    return response.data;
  },
  ...
  getDeliveryRecords: async (
    ...
    const response = await apiClient.get(
      `/delivery/records?${params.toString()}`
    );
    return response.data;
  },
  ...
  getDeliveryStatistics: async (
    ...
    const response = await apiClient.get('/delivery/statistics');
    return response.data;
  },
  ...
  getDeliveryRecord: async (
    ...
    const response = await apiClient.get(`/delivery/records/${id}`);
    return response.data;
  },
  ...
  updateDeliveryRecordStatus: async (
    ...
    const response = await apiClient.put(`/delivery/records/${id}/status`, {
      status,
    });
    return response.data;
  },
  ...
  manualDelivery: async (jobData: {
    ...
    const response = await apiClient.post('/delivery/manual', jobData);
    return response.data;
  },
  ...
  > => {
    const response = await apiClient.get('/delivery/progress');
    return response.data;
  },
};
