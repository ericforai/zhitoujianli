const Pricing = () => {
  const plans = [
    {
      ...
      features: ['每日10次投递', '基础匹配分析', '标准打招呼语', '邮件支持'],
      buttonText: '免费开始',
      popular: false,
    },
    {
      ...
      features: ['每日100次投递', '高级匹配分析', '个性化打招呼语', 'AI优化建议', '优先客服支持'],
      buttonText: '立即升级',
      popular: true,
    },
    {
      ...
      features: ['无限次投递', '团队协作功能', '批量简历管理', '数据分析报告', '专属客户经理'],
      buttonText: '联系销售',
      popular: false,
    },
  ];
  ...
  return (
    <section id='pricing' className='py-28 bg-white scroll-mt-32'>
      <div className='max-w-6xl mx-auto px-6 sm:px-8 lg:px-12'>
        <div className='text-center mb-16'>
          <h2 className='text-2xl md:text-3xl font-bold text-gray-900 mb-4 font-chinese'>
            选择适合你的版本
          </h2>
          <p className='text-lg text-gray-600 max-w-2xl mx-auto'>从免费体验到企业级解决方案</p>
        </div>
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className='text-center'>
                <h3 className='text-2xl font-bold text-gray-900 mb-2 font-chinese'>{plan.name}</h3>
