        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          ...
          <div className='space-y-6'>
            ...
            <div className='bg-white p-6 rounded-lg shadow-sm'>
              ...
              <div className='space-y-4'>
                <div>
                  <label className='block text-sm font-medium text-gray-700 mb-2'>关键词设置</label>
                  <input
                    type='text'
                    value={deliverySettings.keywords}
                    onChange={e =>
                      setDeliverySettings(prev => ({ ...prev, keywords: e.target.value }))
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setDeliverySettings(prev => ({ ...prev, cities: e.target.value }))
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setDeliverySettings(prev => ({ ...prev, maxPages: parseInt(e.target.value) }))
                    }
                    className='w-full'
                  />
                </div>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>基于JD生成个性化打招呼语，提升HR回复率</p>
                  </div>
                </div>
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>投递进度实时跟踪，成功率统计分析</p>
                  </div>
                </div>
              </div>
            </div>
